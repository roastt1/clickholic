          ...
          <div key={type} className="flex flex-col gap-1">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-1">
                ...
                {isRemoved && (
                  <span className="text-[9px]" style={{ color: 'var(--neon-pink)' }}>✕</span>
                )}
                <span
                  className="text-xs tabular-nums font-bold"
                  style={{
                    color:   isRemoved ? 'rgba(255,0,128,0.4)' : isModified ? neon : 'var(--text-muted)',
                    minWidth: '3.2ch',
                    textAlign: 'right',
                  }}
                >
...
export function SymbolOddsPanel() {
  ...
  const odds = useMemo(
    () => calculateSymbolOdds(SYMBOL_POOL, activeEffects),
    [activeEffects],
  )
  ...
  return (
    <>
      ...
      >
        ...
        <OddsList odds={odds} hasModifier={hasModifier} />
        ...
        {sheetOpen && (
          <>
            ...
            >
              ...
              <div className="mt-4 text-center" style={{ borderTop: '1px solid rgba(255,255,255,0.05)', paddingTop: '12px' }}>
